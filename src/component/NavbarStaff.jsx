...
const NavbarStaff=()=>{
    const [UserName,setUserName] = useState("Mr. Aras")
    return (
        <div className="bg-[#360033] fixed w-full top-0">
            ...
            <div className="float-right text-[white] text-center no-underline text-base px-4 py-3.5 cursor-default">{UserName}</div>
